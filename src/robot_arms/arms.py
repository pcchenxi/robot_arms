...
class FrankaLeft(Franka):
    def __init__(self, robot_ip='192.168.31.11', relative_dynamics_factor=0.04):
        ...
        start_joint_pose = np.array([-0.97788733, -1.04903993,  1.31520369, -1.58949637, -0.26875838,  1.36971498, 2.23423306])
...
class KinovaFront(Kinova):
    def __init__(self, robot_ip='192.168.31.13'):
        ...
        start_joint_pose = np.array([-1.42309209, -0.6435582,  -1.49299953, -1.55322426, -0.74144695, -1.49033903, -1.52815965])
